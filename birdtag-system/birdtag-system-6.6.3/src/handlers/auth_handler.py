...
from src.utils.auth_utils import authenticate_user, register_user, require_auth
from src.utils.error_utils import BirdTagError, ErrorCode, create_error_response as create_error
from src.utils.error_utils import validate_required_fields
...
def handle_verify(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        if IS_LOCAL:
            # Local test mode - check for test verification code
            if code == '123456':
                return {
                    'statusCode': 200,
                    'headers': get_cors_headers(),
